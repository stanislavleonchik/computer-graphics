...
void apply_hsv_adjustments(unsigned char* image, std::vector<float>& hsvImage, int width, int height, int channels, float hueAdjust, float saturationAdjust, float brightnessAdjust) {
